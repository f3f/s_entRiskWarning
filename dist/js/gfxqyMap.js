...
// 百度地图API功能
	...
	var map = new BMap.Map("gfxqyMap");
	
    map.enableScrollWheelZoom();

    //mp.centerAndZoom("天津",13);      // 初始化地图,用城市名设置地图中心点
    map.centerAndZoom(new BMap.Point(120.86, 32.01), 15);

    map.setMapStyle({
        style : "normal"
    });
    var sContent1 = "<h4 style='margin:0 0 5px 0;padding:0.2em 0'>测试1</h4>"
            + "<img style='float:right;margin:4px' id='imgDemo' src='../images/放图片.png' width='139' height='104'/>"
            // + "<p style='margin:0;line-height:1.5;font-size:13px;text-indent:2em'>测试1描述...</p>"
            + "</div>";

    var sContent2 =  "<p>企业名称：XXXX</p><p>预警类型：集资诈骗</p>";

    var data_info = [ [ 120.86, 32.01, sContent2,"../images/map_icon.png" ],
                    [ 120.813, 31.8821372, sContent2,"../images/map_icon.png" ],
                    [ 120.800813, 32.16393, sContent2,"../images/map_icon.png" ] ];
    /* var opts = {
                width : 250,     // 信息窗口宽度
                height: 80,     // 信息窗口高度
                title : "信息窗口" , // 信息窗口标题
    ...
    for (var i = 0; i < data_info.length; i++) {
        ...
        var myIcon = new BMap.Icon(data_info[i][3], new BMap.Size(34,42));
